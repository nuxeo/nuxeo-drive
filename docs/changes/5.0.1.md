...
- [NXDRIVE-2499](https://jira.nuxeo.com/browse/NXDRIVE-2499): Run mypy on tests
...
- [NXDRIVE-2555](https://jira.nuxeo.com/browse/NXDRIVE-2555): Use a temporary folder for database storage in `engine_dao` fixture
