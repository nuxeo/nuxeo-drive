...
- Upgraded `sentry-sdk` from 0.17.3 to 0.19.0
...
- Added `completed_at` attribute to `Session`
- Added `created_at` attribute to `Session`
- Added `description` attribute to `Session`
- Added `engine` attribute to `Session`
