...
- [NXDRIVE-2406](https://jira.nuxeo.com/browse/NXDRIVE-2406): Put duplicate documents into the ignore list
- [NXDRIVE-2407](https://jira.nuxeo.com/browse/NXDRIVE-2407): Display 10 documents into the conflicts window
...
- Upgraded `pyobjc-framework-cocoa` from 6.2.2 to 7.0.0
...
- Added `limit` keyword argument to `Engine.get_conflicts()`
...
- Added `limit` keyword argument to `EngineDAO.get_conflicts()`
