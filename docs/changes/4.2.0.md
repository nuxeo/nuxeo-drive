...
- [NXDRIVE-1846](https://hyland.atlassian.net/browse/NXDRIVE-1846): Do not log the whole exception when checking for HTTPS support on a development environment
