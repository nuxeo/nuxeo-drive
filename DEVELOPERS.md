...
This allows to easily create a multi-platform desktop application using the same code base.
...
- The [Dependabot](https://dependabot.com) will automatically check for updates and open a PR if needed.
