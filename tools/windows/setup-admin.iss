...
;Source: "dll\x86\LiferayNativityUtil_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist 32bit
Source: "dll\x64\LiferayNativityUtil_x64.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist 64bit; Check: IsWin64

;Source: "dll\x86\DriveConflictedOverlay_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist regserver 32bit
;Source: "dll\x86\DriveErrorOverlay_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist regserver 32bit
;Source: "dll\x86\DriveLockedOverlay_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist regserver 32bit
;Source: "dll\x86\DriveSyncedOverlay_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist regserver 32bit
;Source: "dll\x86\DriveSyncingOverlay_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist regserver 32bit
;Source: "dll\x86\DriveUnsyncedOverlay_x86.dll"; DestDir: "{app}\dll"; Flags: onlyifdoesntexist regserver 32bit
