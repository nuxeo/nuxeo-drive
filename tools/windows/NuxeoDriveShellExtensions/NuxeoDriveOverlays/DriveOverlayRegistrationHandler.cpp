...
HRESULT DriveOverlayRegistrationHandler::MakeRegistryEntries(const CLSID& clsid, PWSTR friendlyName)
{
	HRESULT hResult;
...
HRESULT DriveOverlayRegistrationHandler::RemoveRegistryEntries(PWSTR friendlyName)
{
	HRESULT hResult;
...
HRESULT DriveOverlayRegistrationHandler::RegisterCOMObject(PCWSTR modulePath, const CLSID& clsid)
{
	if (modulePath == NULL)
	{
		return E_FAIL;
...
HRESULT DriveOverlayRegistrationHandler::UnregisterCOMObject(const CLSID& clsid)
{
	wchar_t stringCLSID[MAX_PATH];
