"""Integration tests for direct download feature - Windows only."""
...
class TestDirectDownloadUrl:
    """Test direct download URL handling - Windows only."""
...
class TestDirectDownloadEndToEnd:
    """End-to-end integration tests for direct download on Windows."""
