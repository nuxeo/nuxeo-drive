...
class TestLocalMoveAndRename(UnitTestCase):
    ...
    def setUp(self):
        ...
        # Same content as OF1
        local.make_file('/Original Folder 1', 'Original File 1.1.txt',
                        content=b'Some Content 1')

        local.make_folder('/', 'Original Folder 2')
        local.make_file('/Original Folder 2', 'Original File 3.txt',
                        content=b'Some Content 3')
    ...
    def test_local_rename_file(self):
        ...
        local.rename('/Original Folder 1/Original File 1.1.txt',
                     'Renamed File 1.1 \xe9.txt')
    ...
    def test_local_rename_folder_while_suspended(self):
        ...
        local.rename('/Renamed Folder 1 \xe9/Sub-Folder 1.1',
                     'Sub-Folder 2.1')
        assert local.exists('/Renamed Folder 1 \xe9/Sub-Folder 2.1')

        # Same content as OF1
        local.make_file('/Renamed Folder 1 \xe9', 'Test.txt',
                        content=b'Some Content 1')
        count += 1
    ...
    def test_local_move_folder(self):
        ...
        assert len(local.get_children_info(
            '/Original Folder 2/Original Folder 1')) == 3
