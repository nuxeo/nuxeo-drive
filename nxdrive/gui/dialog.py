...
from PyQt5.QtWebEngineWidgets import (QWebEngineCertificateError,
                                      ...
                                      QWebEngineView)
from PyQt5.QtWidgets import QDialog, QMessageBox, QVBoxLayout, QMenu

from nxdrive.client.proxy import get_proxy
from nxdrive.exceptions import (FolderAlreadyUsed, InvalidDriveException,
                                NotFound, RootAlreadyBindWithDifferentAccount,
                                StartupPageConnectionError)
from nxdrive.objects import Binder
