        ...
        try:
            ...
            if isinstance(result, dict):
                ...
                if download_url:
                    ...
                    download_url = (
                        f"{self.client.host}/nuxeo/api/v1/automation/Blob.BulkDownload"
                    )
            ...
            log.warning(
                f"Blob.BulkDownload operation failed: {e}, trying alternative method"
            )
            ...
            try:
                ...
                raise NotFound(
                    ...
                    "bulk downloads or the operation is not available."
                )
