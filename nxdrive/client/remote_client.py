    ...
    def download(
        ...
        try:
            if chunked:
                ...
                file_out.write_bytes(resp.content)
    ...
    def upload(
        ...
        **params: Any,
        ...
        with self.upload_lock:
            tick = time.monotonic()
            path = file_path.with_name(filename) if filename else file_path
            action = UploadAction(path, file_path, reporter=QApplication.instance())
