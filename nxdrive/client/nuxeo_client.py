...
from nxdrive.utils import get_device, unlock_path, lock_path
from ..constants import (APP_NAME, FILE_BUFFER_SIZE, TIMEOUT, BLOB_TIMEOUT,
                         TX_TIMEOUT, TOKEN_PERMISSION)
...
class BaseNuxeo(Nuxeo):
    def __init__(
        ...
        kwargs.pop('proxy_exceptions', None)
