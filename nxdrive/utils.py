...
def is_generated_tmp_file(name: str) -> Tuple[bool, bool]:
    """
...
def find_resource(folder: str, filename: str='') -> Union[str, None]:
...
def parse_protocol_url(url_string: str) -> Union[Dict[str, str], None]:
    """
...
def parse_edit_protocol(parsed_url: str, url_string: str) -> Dict[str, str]:
