...
class BaseAutomationClient(BaseClient):
    ...
    def __init__(self, server_url, user_id, device_id, client_version,
        ...
        # New chunking upload API
        self.chunking_upload_available = True
        self.rest_api_url = server_url + 'api/v1/'
        self.batch_chunking_upload_url = 'upload'
    ...
    def init_upload(self):
        url = self.rest_api_url + self.batch_chunking_upload_url
        headers = self._get_common_headers()
    ...
    def is_chunking_upload_available(self):
        return self.chunking_upload_available
