...
class TestIntegrationVersioning(IntegrationTestCase):
    ...
    def setUp(self):
        ...
        # Call the Nuxeo operation to set the versioning delay to 5 seconds
        self.versioning_delay = self.OS_STAT_MTIME_RESOLUTION * 5
    ...
    def test_versioning(self):
        ...
        # since the versioning delay (5s) is not passed by
        time.sleep(self.OS_STAT_MTIME_RESOLUTION)
        self.local_client_2.update_content('/Test versioning.txt',
        ...
        # Update it as user 2 after 5s => should be versioned
