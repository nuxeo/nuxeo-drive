...
class TestBulkRemoteChanges(UnitTestCase):
    ...
    def test_many_changes(self):
        ...
        self.step("""3. Create files inside the 3 folders:
        ...
        remote_client.make_file(shared, "readme2.txt", "This is a readme file")
        ...
        self.step("10. Sleep for two remote scan attempts (to compensate for two network failures)")
